...
import { ShowBookProps } from '../../config/interfaces/Book/ShowBookProps'
...
const ShowBookData = ({ book }: ShowBookProps) => {
	...
	return (
		<div className="p-4 h-full ">
			{showDelete && <DeleteBook id={id||'0'} setShowDelete={setShowDelete} />}{' '}
			<div className="flex gap-x-8  mb-4 ">
				...
				<div className=" flex gap-x-4 flex-end	">
					...
					<Button
						...
						size="large"
						className="bg-[#1e50c7]"
						onClick={() => navigate(`/dashboard/books/update/${book.id}`)}
					>
						Edit
					</Button>
				</div>
